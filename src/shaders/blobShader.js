...
export const ColorShiftMaterial = shaderMaterial(
    ...
    uniform float distortion;
        ...
        aniNormal = aniNormal * distortion;
            ...
            vec3 newPosition = position + f0 * evNormal; //* strength
            vec3 nWorld = normalize( mat3( modelMatrix[0].xyz, modelMatrix[1].xyz, modelMatrix[2].xyz ) * modifiedNormal );
            vReflect = normalize( reflect( normalize( newPosition.xyz - cameraPosition ), nWorld ) ) * 10.0;
    ...
    varying vec2 vUv;
            ...
            void main() {
                ...
                float diffuse_value1 = .0005 * max(dot(vNormal, vec3( -490.0, 29.8, -85.8 ) ), 0.0);
